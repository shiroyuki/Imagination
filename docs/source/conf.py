# -*- coding: utf-8 -*-
#
# Imagination documentation build configuration file, created by
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.coverage', 'sphinx.ext.imgmath', 'sphinx.ext.viewcode']
...
htmlhelp_basename = 'Imaginationdoc'
